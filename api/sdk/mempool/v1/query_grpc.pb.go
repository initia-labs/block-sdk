...
const (
	Service_GetTxDistribution_FullMethodName = "/sdk.mempool.v1.Service/GetTxDistribution"
)
...
func (c *serviceClient) GetTxDistribution(ctx context.Context, in *GetTxDistributionRequest, opts ...grpc.CallOption) (*GetTxDistributionResponse, error) {
	...
	err := c.cc.Invoke(ctx, Service_GetTxDistribution_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedServiceServer) GetTxDistribution(context.Context, *GetTxDistributionRequest) (*GetTxDistributionResponse, error) {
...
func _Service_GetTxDistribution_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Service_GetTxDistribution_FullMethodName,
	}
